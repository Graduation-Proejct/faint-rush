      ...
      <div className="flex justify-center   h-auto  max-w-xl w-full relative  bg-patienthome rounded-b-3xl">
        ...
        <div className=" flex flex-col pt-20  " >
          <div className="">
            ...
            <img src={dd} className="  rounded-full border-white bg-black w-12 h-12 border-4 m-auto absolute  right-0 top-0"></img>
         ...
         <div className="flex flex-col  ">
          <h4 className="flex font-mono text-3xl font-extrabold text-crazyblue mb-2 items-start" >Good Evening,
            <br></br>
            {user.username}</h4>
          </div>

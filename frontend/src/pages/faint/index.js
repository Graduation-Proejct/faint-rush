  ...
  return (
    <div className="flex flex-col items-center ">
      <div className=" pt-8  pb-6 h-screen font-mon flex flex-col items-center max-w-md w-full bg-[#F75010]">
        <span className="block text-white font-bold font[Helvetica] text-[40px]">FAINT DETECTED!</span>
        <span className=" pt-5 block text-white font-bold font[Helvetica] text-[23px]">Mahmoud fainted on: {showTime}</span>
